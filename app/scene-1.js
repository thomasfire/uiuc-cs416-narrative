...
const LINE_COLORS = {
    ...
    "Class A New Territories": "#00cc88",
    "Class B Hong Kong": "#0099dd",
    "Class B Kowloon": "#dd9900",
    "Class B New Territories": "#00dd99",
    "Class C Hong Kong": "#00acff",
    "Class C Kowloon": "#ffae00",
    "Class C New Territories": "#1aff00",
    "Class D Hong Kong": "#33bdff",
    "Class D Kowloon": "#ffbd33",
    "Class D New Territories": "#33ff33",
    "Class E Hong Kong": "#66ceff",
...
window.addEventListener('resize', function () {
    ...
    if (sceneGraphElement) {
        const width = sceneGraphElement.offsetWidth * 0.95;
        const height = width * 3 / 4;
        scene1.updateSize(width, height, 'scene_svg_1', '/data/Monthly_rents_avg_annual.csv');
    } else {
